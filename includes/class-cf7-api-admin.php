        ...
        <fieldset>
          ...
          <div class="cf7_row">
              <label for="wpcf7-sf-basic_auth">
                  <?php _e( 'Basic auth' , $this->textdomain );?>
                  <input type="text" id="wpcf7-sf-basic_auth" name="wpcf7-sf[basic_auth]" class="large-text" value="<?php echo $wpcf7_api_data["basic_auth"];?>"
